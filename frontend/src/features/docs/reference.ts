    ...
    blocks: [
      {
        ...
        what: "On a fresh machine the run surface is replaced by a setup guide with a card per engine: llama.cpp (local, bundled) and the remote vLLM / SGLang servers.",
